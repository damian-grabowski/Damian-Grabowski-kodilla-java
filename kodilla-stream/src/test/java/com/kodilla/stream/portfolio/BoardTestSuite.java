...
public class BoardTestSuite {
    public Board prepareTestData() {
        //users
        User user1 = new User("developer1", "Mateusz Kącki");
        User user2 = new User("projectmanager1", "Kuba Placha");
        User user3 = new User("developer2", "Krystian Bagiński");
        User user4 = new User("developer3", "Mateusz Żak");
        //tasks
        Task task1 = new Task("Microservice for taking temperature",
                "Write and test the microservice taking/n" +
    ...
    public void testAddTaskListFindUsersTasks() {
        ...
        Board project = prepareTestData();
        //When
        User user = new User("developer1", "Mateusz Kącki");
